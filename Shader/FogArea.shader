    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float cullMask = outsideCube ? asfloat(0x7FC00000) : 1.0;

                o.pos = TransformObjectToHClip(v.vertex.xyz) * cullMask;
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float edgeFadeFactor = saturate(minDistWorld / _EdgeFade);
                ...
                col.a = saturate(fogAmount) * col.a * edgeFadeFactor;
                return col;
            }
            ENDHLSL
        }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                // EdgeFadeの計算（外側が0、EdgeFadeの長さより内側に行ったら1倍）
                float edgeFadeFactor = saturate(minDistWorld / _EdgeFade);
